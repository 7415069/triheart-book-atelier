            ...
            <div class="meta-footer">
              <div class="price-row">
                <template v-if="!isPurchased">
                  <div class="sale-price"><span class="symbol">¥</span>{{ book.bookSalePrice?.toFixed(2) }}</div>
                  <div class="list-price" v-if="book.bookListPrice">原价 ¥{{ book.bookListPrice.toFixed(2) }}</div>
                </template>
